                     ...
                     <form method="post" action="<?php echo base_url('/customer/update/'.$id)?>" enctype="multipart/form-data">
                       ...
                       <label class="label_field">Email </label>
                           ...
                           <div class="field">
                              ...
                              <input type="number" name="phone" placeholder="Enter Your Number" value="<?=  $phone_Number ?>" />
                           </div>
                           <div class="field">
                              <label class="label_field">Address</label>
                              <textarea name="" id="" cols="25" rows="5"></textarea placeholder='Enter Your Address' name='address'> 
                           </div>
                           <div class="field">
                              <label class="label_field">State</label>
                              <input type="text" name="state" placeholder="Enter Your State" value="<?= $state ?>" />
                           </div>
                           <div class="field">
                              <label class="label_field">Date</label>
                              <input type="date" name="date" placeholder="Enter Date" value="<?= $created_at ?>" />
                           </div>
                           <div class="field">
                              <label class="label_field">Subject</label>
                              <textarea name="" id="" cols="25" rows="5"></textarea placeholder='Enter Your Subject' name='subject'>
                           </div>
                           <div class="field">
