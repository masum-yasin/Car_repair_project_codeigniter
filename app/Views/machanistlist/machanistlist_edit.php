                        ...
                        <div class="row">
                            ...
                            <?php endif; ?>
                                            <div class="login_form">
                                                <form method="post" action="<?php echo site_url('/mechanist/update/'.$id) ?>" enctype="multipart/form-data">
                                                    <fieldset>
                                                        <div class="field">
                                                            <label class="label_field">Mechanist</label>
                                                            <input type="text" name="mechanist" placeholder="Enter Mechanist Name" value="<?= $name ?>" />
                                                        </div>
                                                        <div class="field">
                                                            <label class="label_field">Contact</label>
                                                            <input type="number" name="contact" placeholder="Contact Number" value="<?= $contact?>" />
                                                        </div> 
                                                        <div class="field">
                                                        ...
                                                        <div class="field">
                                                            ...
                                                            <input type="date" name="date" placeholder="Joining Date" />
                                                        </div>
                                                        <div class="field">
                                                            <label class="label_field">UPLOAD IMAGE</label>
                                                            <input type="file" name="image" placeholder="UPLOAD IMAGE" value="<?=$image ?>" />
                                                        </div>
